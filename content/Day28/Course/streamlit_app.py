...
st.set_page_config(page_title='Day28 - Course App', layout='centered')
st.title('Day28: streamlit-shap')
st.caption('Automatisch aus content/Day28.md erzeugte Kurs-App')

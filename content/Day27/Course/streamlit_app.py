...
st.set_page_config(page_title='Day27 - Course App', layout='centered')
st.title('Day27: Build a draggable and resizable dashboard with Streamlit Elements')
st.caption('Automatisch aus content/Day27.md erzeugte Kurs-App')
